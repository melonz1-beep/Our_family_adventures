...
const CORE=['./','./index.html','./404.html','./style.css?v=9.1.7','./manifest.json?v=9.1.7','./firebase-config.js?v=9.1.7','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png','./icons/badge-96.png'];
