/* Our Family Adventures 9.4.2 PWA cache worker. Push is handled by firebase-messaging-sw.js. */
const CACHE='ofa-9-4-2';
const OFFLINE='./index.html?v=9.4.2';
const CORE=['./','./index.html?v=9.4.2','./404.html','./style.css?v=9.4.2','./manifest.json?v=9.4.2','./firebase-config.js?v=9.4.2','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png','./icons/badge-96.png'];
