const CACHE_NAME='ofa-v6-1-cache';
const FILES=['./','./index.html','./style.css?v=6.1','./app.js?v=6.1','./firebase-config.js?v=6.1','./manifest.json?v=6.1','./assets/lighthouse-home.svg','./assets/splash-background.svg','./icons/icon-192.svg','./icons/icon-512.svg'];
