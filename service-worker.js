/* Our Family Adventures 10.3.9 PWA cache worker. Push is handled by firebase-messaging-sw.js. */
const CACHE='ofa-10-3-9';
const OFFLINE='./index.html?v=10.3.9';
const CORE=['./','./index.html?v=10.3.9','./404.html','./style.css?v=10.3.9','./scrapbook-studio-2.css?v=10.3.9','./app.js?v=10.3.9','./scrapbook-studio-2.js?v=10.3.9','./manifest.json?v=10.3.9','./firebase-config.js?v=10.3.9','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png'];
