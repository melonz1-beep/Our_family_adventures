/* Our Family Adventures 10.3.12.1 PWA cache worker. Push is handled by firebase-messaging-sw.js. */
const CACHE='ofa-10-3-12-1';
const OFFLINE='./index.html?v=10.3.12.1';
const CORE=['./','./index.html?v=10.3.12.1','./404.html','./style.css?v=10.3.12.1','./scrapbook-studio-2.css?v=10.3.12.1','./scrapbook-studio-2-upgrades.css?v=10.3.12.1','./app.js?v=10.3.12.1','./scrapbook-studio-2.js?v=10.3.12.1','./scrapbook-studio-2-upgrades.js?v=10.3.12.1','./version-10-3-12-hotfix.js?v=10.3.12.1','./manifest.json?v=10.3.12.1','./firebase-config.js?v=10.3.12.1','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png'];
