/* Our Family Adventures 10.3.8 PWA cache worker. Push is handled by firebase-messaging-sw.js. */
const CACHE='ofa-10-3-8';
const OFFLINE='./index.html?v=10.3.8';
const CORE=['./','./index.html?v=10.3.8','./404.html','./style.css?v=10.3.8','./scrapbook-studio-2.css?v=10.3.8','./app.js?v=10.3.8','./scrapbook-studio-2.js?v=10.3.8','./manifest.json?v=10.3.8','./firebase-config.js?v=10.3.8','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png'];
