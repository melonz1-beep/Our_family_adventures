/* Our Family Adventures 10.1.8 PWA cache worker. Push is handled by firebase-messaging-sw.js. */
const CACHE='ofa-10-1-1';
const OFFLINE='./index.html?v=10.1.8';
const CORE=['./','./index.html?v=10.1.8','./404.html','./style.css?v=10.1.8','./manifest.json?v=10.1.8','./firebase-config.js?v=10.1.8','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png','./icons/badge-96.png'];
