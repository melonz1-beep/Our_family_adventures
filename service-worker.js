const CACHE_NAME = 'ofa-6-5-2-core';
const FILES = [
  './',
  './index.html',
  './style.css?v=6.5.2',
  './final-6.4.1.css?v=6.5.2',
  './ofa-6.5.0.css?v=6.5.2',
  './ofa-6.5.2.css?v=6.5.2',
  './app.js?v=6.5.2',
  './final-6.4.1-patch.js?v=6.5.2',
  './ofa-6.5.0.js?v=6.5.2',
  './ofa-6.5.2.js?v=6.5.2',
  './firebase-config.js?v=6.5.2',
  './manifest.json',
