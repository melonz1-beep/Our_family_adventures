/* Our Family Adventures 9.4.4 PWA cache worker. Push is handled by firebase-messaging-sw.js. */
const CACHE='ofa-9-4-3';
const OFFLINE='./index.html?v=9.4.4';
const CORE=['./','./index.html?v=9.4.4','./404.html','./style.css?v=9.4.4','./manifest.json?v=9.4.4','./firebase-config.js?v=9.4.4','./assets/lighthouse-home.png','./icons/icon-192.png','./icons/icon-512.png','./icons/badge-96.png'];
