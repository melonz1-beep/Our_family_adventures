# Our Family Adventures 9.4.1 — Reliable Trip Deletion

Version 9.4.1 changes trip deletion to a verified Firebase-first operation.
...
3. Open the site with `?v=9.4.1` and refresh once.
