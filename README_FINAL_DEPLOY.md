...
## 6.3.2 Invite-Only Firebase Security
This build adds invite-only Firebase account creation, approved family membership checks, shared protected family app data, and updated Firestore/Storage rules. See `INVITE_ONLY_FIREBASE_SECURITY.md`.
