# Our Family Adventures 8.1 — Deploy Package
...
3. If an old version appears, clear site data or uninstall/reinstall the home-screen app. Version 8.1 uses a new service-worker cache: `ofa-8-1-0`.
